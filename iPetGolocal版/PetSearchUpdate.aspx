<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PetSearchUpdate.aspx.cs" Inherits="RegisterMember" %>
                         ...
                         <div class="row carousel-holder">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12 col-sm-12">
                                    <form id="form" runat="server" >
                                        <div>
                                            <p class="auto-style3" style=" margin:0px auto; width:100%; height:50px; background-color:#2461BF;border: 5px solid  #2461BF;
	                                           border-radius: 10px;padding:5px; color:#FFF" align="center">寵物失蹤資料更新編輯</p>
                                        </div>
                                       <br />
                                        <div class="row">
                                          <div class="col-md-6 col-xs-6 col-sm-6">
                                              <div class="form-group">
                                                <label for="username"><span class="auto-style2">寵物走失狀態</span></label> 
                                                <asp:DropDownList ID="listStatus" runat="server" class="form-control">                                                    
                                                      <asp:ListItem Value="協尋中">協尋中</asp:ListItem>
                                                      <asp:ListItem Value="已尋回">已尋回</asp:ListItem>
                                                  </asp:DropDownList>                      
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-6 col-xs-6 col-sm-6">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <asp:Image ID="ImagePrevious" runat="server" width="100%" Height="200px" class="img-thumbnail form-control"  />
                                              </div>
                                      ...
                                      <div class="row">
                                          <div class="col-md-12 col-xs-12 col-sm-12">
                                               <div class="form-group">
                                                    <label for="missplace"><span class="auto-style2">走失地點</span><span class="auto-style4"> </span> <span style="color:red"><span class="auto-style4">*請將坐標移動至您寵物走失的地點附近</span></span></label>
                                    ...
                                    <br />
                                        <div class="col-md-12">
                                            <asp:Button ID="btnUpdate" runat="server" Text="更新資訊" class="btn btn-danger" OnClick="btnUpdate_Click" OnClientClick="return confirm('確定更新寵物資訊嗎?')"/> 
                                            <asp:Button ID="btnBack" runat="server" Text="返回上一頁" class="btn btn-info" OnClick="btnBack_Click" OnClientClick="return confirm('確定放棄編輯資料回上一頁嗎?')" /> 
                                        </div>
...
$("#datepicker").datepicker({
  ...
  buttonImageOnly: true
    ...
    <script>
            ...
            var map;
            var marker;
            var getLat = parseFloat(document.getElementById('txtlatitude').value);
            var getLng = parseFloat(document.getElementById('txtlongitude').value);
            console.log(getLat);
            console.log(getLng);

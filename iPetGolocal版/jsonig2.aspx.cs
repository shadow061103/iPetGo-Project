...
public partial class jsonig2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.HttpMethod == "POST")
        {
          ...
          //  SqlConnection con = new SqlConnection(scsb.ToString());
           ...
           .ConnectionString);
            ...
            string strSQL = "insert into tMessage values('" + memberid + "','" + igid + "', N'" + message + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "');";
        ...
        */
        ...
        if (Request.HttpMethod == "GET")
        {
            ...
            string strSQL = "select MemberAccount,[Message],IGId,CreateDate from tMessage t inner join Member m on t.MemberId = m.MemberId where IGId = N'" + myName + "';";
            SqlCommand cmd = new SqlCommand(strSQL, con);

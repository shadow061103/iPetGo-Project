...
public partial class jsonig : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string strSQL = "SELECT IGid,MemberAccount,MemberImage,ImagePath,UserMessage,LikeIg,M.MemberId,MemberEmail FROM Member M INNER JOIN tIG I ON (M.MemberId=I.MemberId) Order By I.IGid desc";
